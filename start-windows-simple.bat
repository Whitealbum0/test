@echo off
echo.
echo Starting portfolio site (Development mode)
echo.
...
start "Portfolio Frontend" cmd /k "cd /d "%cd%" && echo Frontend running at http://localhost:3000 && yarn start"
...
echo.
echo To stop use: stop-services-windows.bat
echo For production: start-production-windows-fixed.bat
echo.
