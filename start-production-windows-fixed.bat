@echo off
echo.
echo Starting portfolio site in production mode (Windows)
echo.
...
echo 3. Setup SSL certificates for HTTPS (run setup-ssl-windows.bat)
echo.
echo To stop services use: stop-services-windows.bat
echo.
pause